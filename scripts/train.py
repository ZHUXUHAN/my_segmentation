...
from core.utils.lr_scheduler import WarmupPolyLR,WarmupMultiStepLR
...
def parse_args():
    ...
    parser.add_argument('--iteration', type=int, default=0,
                        help='iteration for eval or demo')
...
class Trainer(object):
    def __init__(self, args):
        ...
        # self.lr_scheduler = WarmupMultiStepLR(self.optimizer,
        #                                       [4680, 5460])
    ...
    def train(self):
        ...
        for iteration, (images, targets, _) in enumerate(self.train_loader):
            ...
            if iteration % save_per_iters == 0 and save_to_disk:
                save_checkpoint(self.model, self.args, iteration//self.args.iters_per_epoch, is_best=False)
...
def save_checkpoint(model, args, epoch, is_best=False):
    ...
    filename = '{}_{}_{}_{}.pth'.format(args.model, args.backbone, args.dataset, epoch)
